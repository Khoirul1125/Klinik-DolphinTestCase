...
<body class="layout-fixed">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 - {{ date('Y') }} - Dibuat oleh <a href="https://dolphinhealthtech.co.id/" target="_blank">dolphinhealthtech</a></strong>

        </footer>


        <div class="modal fade" id="licenseErrorModal" tabindex="-1" aria-labelledby="licenseErrorLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="licenseErrorLabel">License Error</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p id="licenseErrorMessage"></p>
                    </div>
...
<script>
    $(document).ready(function() {
        // Cek apakah session error tersedia
        @if(session('license_error'))
            $('#licenseErrorMessage').text("{{ session('license_error') }}");
            $('#licenseErrorModal').modal('show'); // Tampilkan modal
        @endif
    });
</script>
    <!-- ./wrapper -->
    ...
    <script>
        $(function () {
            // Summernote dengan tinggi yang lebih besar
            $('#summernote').summernote({
                height: 300 // Ubah angka sesuai kebutuhan (dalam piksel)
            });
        });
    </script>
