    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-circle"
                                    src="{{ asset('uploads/doctor_photos/'. $doctor->user->profile) }}" alt="User profile picture">
                            </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item text-center">
                                    <a class="float">{{  $doctor->nama_dokter }}</a>
                                </li>
                                <li class="list-group-item text-center">
                                    <b>Jabatan : </b> <a class="float">{{  $doctor->jabatans->nama }}</a>
                                </li>
                                <li class="list-group-item text-center">
                                    <b>Poli : </b><a class="float">{{  $doctor->polis->nama_poli }}</a> <br>
                                </li>
                            </ul>
                        </div>
                        <!-- /.card-body -->
                ...
                <div class="col-md-9">
                    <form action="{{ route('dokter.index.detail.add', ['id' => $doctor->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card card-primary card-outline">
