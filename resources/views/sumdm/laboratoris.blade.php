                ...
                <div class="mt-3 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 card-title">Laboratoris</h3>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Identitas Laboratoris</h5>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="nama" class="form-control" id="nama_laboratoris" name="nama_laboratoris">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
